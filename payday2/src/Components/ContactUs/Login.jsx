                ...
                <div className="flex flex-col-reverse lg:flex-row shadow-2xl rounded-2xl">
                    ...
                    <div className=' h-auto w-auto md:h-[370px] md:w-[450px] bg-white  rounded-2xl  flex flex-col md:flex-row items-center justify-center px-8'>
                        ...
                        <div className=''>
                            ...
                            <div className="mb-4">
                                ...
                                <input type="text" id="username" ref={lname} name="username" className="w-full md:w-[350px] border-[1px] border-[#838383c9] rounded-[15px] px-3 py-2 mt-1 focus:outline-none " placeholder="Enter your username" required />
                            </div>

                            {/* Password */}
                            <div className="mb-4">
                                <label style={{ fontFamily: "Montserrat" }} htmlFor="password" className="block text-gray-700 font-bold">Password:</label>
                                <input type="password" id="password" ref={lpass} name="password" className="w-full border-[1px] border-[#838383c9] rounded-[15px] px-3 py-2 mt-1 focus:outline-none " placeholder="Enter your password" required />
                            </div>
                    ...
                    <div className=" block w-full  lg:h-[370px] md:w-[450px] text-[#f1f9ef]  bg-gradient-to-r  from-gradfrom to-gradto   lg:rounded-r-2xl   rounded-t-2xl   lg:rounded-tl-[0px]   ">
                        ...
                        <div className="flex flex-col items-center lg:py-12 py-2  px-8  text-white">
                            <h1 style={{ fontFamily: "Montserrat" }} className=" select-none font-semibold font-Montserrat text-[30px]  my-2">Welcome to login</h1>

                            <a href='/' className="hover:underline"> dont you have an accout?</a>


                            <button onClick={handleSignup} className=" select-none text-title transition-all  duration-300 text-white  hover:text-primary border-[2px] border-transparent  hover:border-[2px]  hover:border-primary  tracking-[1px] py-2  flex justify-center items-center rounded-[25px] bg-gradient-to-r px-10  from-gradfrom to-gradto hover:bg-gradient-to-r my-8  hover:from-[#ffffff] hover:to-[#ffffff]">
                                SIGN UP
                            </button>
